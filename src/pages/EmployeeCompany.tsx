    ...
    return (
        <div className='mb-8'>
            <div className='flex mx-auto w-3/4 mt-6'>
                <h3 className='text-gray-500 text-18 leading-23'>There are total {searchResults?.length} companies</h3>
            </div>
            <div className='mx-auto  flex justify-center items-center bg-white rounded-full shadow-md mb-12 mt-3'>
                <div className='px-4 w-full flex items-center pt-2 pb-2'>
                    ...
                    />
                    <Button className='w-[18%] rounded-full text-md text-white bg-[#275df5] hover:bg-[#275df5ee]' onClick={handleButtonClick}>
                        Search </Button>
                </div>
            </div>
