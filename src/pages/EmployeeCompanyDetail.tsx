                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='h-12 pt-2 mb-0'>
                            <div className='flex justify-start mr-30 '>
                                <div
                                    className={`pr-8 pl-10 text-2xl rounded font-bold cursor-pointer hover:text-blue-500 transition duration-300 bg-beautiful ${
                                ...
                                <div
                                    className={`px-8 mx-2 rounded text-2xl font-bold cursor-pointer hover:text-blue-500 transition duration-300 bg-beautiful ${
